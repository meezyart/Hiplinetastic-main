...
(function($) {
    ...
    //     console.log('windoe scolling', window.pageYOffset + 'px')
    ...
    $window.on('scroll', function() {
        console.log('scolling', $window.scrollTop())
    ...
    //             .removeClass('open')
    //     }
    //     if (!$(e.target).closest('.site-main-mobile-menu-inner').length &&
    ...
    //     Count Down Active
    // ----------------------------------*/
    // $('[data-countdown]:not(.pro-countdown-1,.pro-countdown-2)').each(
    //     function() {
    //         var $this = $(this),
    ...
    //         $this.html(
    //             event.strftime(
    //                 '<div class="countdown-item before-none"><span>%D</span></div><div class="countdown-item"><span>%H</span></div><div class="countdown-item"><span>%M</span></div><div class="countdown-item"><span>%S</span></div>'
    //             )
    //         )
    //     })
    // })
